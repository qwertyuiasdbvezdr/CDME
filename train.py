...
# if 'UIEB-New-CAM-ChangeDepp_addition-2222' in config['name']:
#     tr_input_path='/home/hz/CCMSRNet/UIEB/train/raw/'
#     tr_input_depth_path = '/home/hz/CCMSRNet/UIEB/output_monodepth_train-UIEB/'
#     tr_gt_path = '/home/hz/CCMSRNet/UIEB/train/ref/'
#     val_input_path = '/home/hz/CCMSRNet/UIEB/vali/raw/'
#     val_input_depth_path = '/home/hz/CCMSRNet/UIEB/vali/output_monodepth_vali-UIEB/'
#     val_gt_path = '/home/hz/CCMSRNet/UIEB/vali/ref/'
if 'EUVP-New-CAM-ChangeDepp_addition--add_exp_CCMSRNet.yml' in config['name']:
    tr_input_path='/home/hz/CCMSRNet/EUVP-Scenes/train-Scenes/raw-png/'
    tr_input_depth_path = '/home/hz/CCMSRNet/EUVP-Scenes/train-Scenes/output_monodepth_EUVP-Scenes/'
    tr_gt_path = '/home/hz/CCMSRNet/EUVP-Scenes/train-Scenes/ref-png/'
    val_input_path = '/home/hz/CCMSRNet/EUVP-Scenes/test-Scenes/raw-png/'
    val_input_depth_path = '/home/hz/CCMSRNet/EUVP-Scenes/test-Scenes/output_monodepth_test-Scenes/'
    val_gt_path = '/home/hz/CCMSRNet/EUVP-Scenes/test-Scenes/ref-png/'
print(f'input path:{tr_input_path} --- gt path:{tr_gt_path}--- gt path:{tr_input_depth_path}')
train_lst = get_file_lst(tr_input_path, tr_gt_path, tr_input_depth_path)
...
print(f'val input:{val_input_path}--- val gt:{val_gt_path}---gt path:{val_input_depth_path}')
val_lst = get_file_lst(val_input_path,val_gt_path, val_input_depth_path)
if args.resize_val:
...
def train(net,num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        for data in tqdm(train_loader):
            ...
            cc, pred = net(image,new_image,depth)
        ...
        print(f"epoch:{epoch + 1}/{num_epochs}, mse loss{tr_loss_meter.avg:.5f}, time:{toc - tic}")
